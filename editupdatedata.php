...
<section class="jumbotron text-center">
        ...
        <p class="lead">Silahkan edit data user yang diinginkan</p>
      </section>
    <!-- END JUMBOTRON-->
...
<!--start update form -->
  ...
  <div class="card-body">
	  ...
	  <div class="form-group">
  			...
  			<input type="text" name="nama_lengkap" value="<?=@$vnama?>" class="form-control" placeholder="Input Nama Lengkap Baru">
  		</div>
